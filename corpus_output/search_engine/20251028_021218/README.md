...
생성 일시: 2025-10-28T02:12:18.358216
총 단어 수: 20
동의어 그룹: 3
...
### 1. 파일 다운로드
```bash
aws s3 cp s3://neologismgluestack-neologismdatabucket964d4a93-x7prphtbefoc/output/corpus/search_engine/20251028_021218/ . --recursive
```
