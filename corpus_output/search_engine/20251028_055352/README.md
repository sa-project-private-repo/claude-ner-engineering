...
생성 일시: 2025-10-28T05:53:53.223151
총 단어 수: 59
동의어 그룹: 1
...
### 1. 파일 다운로드
```bash
aws s3 cp s3://neologismgluestack-neologismdatabucket964d4a93-x7prphtbefoc/output/corpus/search_engine/20251028_055352/ . --recursive
```
